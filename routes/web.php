...
Route::get('/test',[\App\Http\Controllers\TestController::class,'feed']);
...
Route::group([ 'role'=>['admin','audit'],'middleware'=>['auth','domain', 'auth.role'],'prefix'=>'backend'], function () {
    ...
    Route::get('/product/{product}/notification/{notification}/redo',[App\Http\Controllers\NotificationController::class, 'redo'])->name('product.notification.redo');
