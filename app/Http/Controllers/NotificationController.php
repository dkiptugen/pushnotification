                        ...
                        foreach ($posts as $post)
                            {
                                ...
                                $nestedData['action']           =   "<a href='".route('product.notification.edit',[$post->product_id,$id])."' class='text text-dark mr-2'><i class='fas fa-edit'></i></a>
                                                                    <a href='".route('product.notification.redo',[$post->product_id,$id])."' class='text text-dark'><i class='fas fa-redo-alt'></i></a>";
                                $data[] = $nestedData;
                                $pos++;
                            }
                    }
