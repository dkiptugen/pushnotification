...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="" id="airtimeForm" class="airtimeForm"
                method="POST">
                <div class="modal-body">
                    @csrf
                    <div class="form-group">
                        <label for="FormControlPhoneNumber"><strong>Enter Amount: </strong></label>
                    ...
                    <div class="form-group own_mobile_number">
                        ...
                        <input type="text" required name="mpesa_phone_number" class="form-control"
                            id="mpesa_phone_number" placeholder="Enter mpesa mobile number">
                    </div>
                    <div class="form-group enter_mobile_number">
                        <label for="FormControlPhoneNumber"><strong>Recipient Phone Number: </strong></label>
                        <input type="text" required name="recipient_phone_number" class="form-control"
                            id="recipient_phone_number" placeholder="Enter recipient mobile number">
                    </div>
                    <div class="form-group">
                        <label for="FormControlSurvey"><strong>Select Recipient Network:</strong></label>
                        <select class="form-select form-control" id="network" name="network"
                    ...
                    <div class="form-group ">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="airtime_confirmation"
                                name="airtime_confirmation" value="confirmation" id="flexRadioDefault2">
...
<div class="btn-group-fab" role="group" aria-label="FAB Menu">
    <div>
        <span data-toggle="modal" data-target="#exampleModalCenter">
            <button type="button" class="btn btn-main btn-primary" data-toggle="tooltip" data-placement="top"
                title="Buy Airtime"> <i class="fa fa-money fa-3x" aria-hidden="true"></i> </button>
        </span>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
                    <h3><strong>Airtime Confirmation</strong></h3>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                ...
                <p>Mpesa Phone Number: <strong><span id="confirm_mpesa_phone_number"
                            class="confirm_mpesa_phone_number"></span></strong></p>

                <p>Recipient Phone Number: <strong><span id="confirm_recipient_phone_number"
                            class="confirm_recipient_phone_number"></span></strong></p>
...
{{-- payment options --}}
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="payment_options" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <hr>
                <p>Check your mobile phone handset for an instant payment request from Safaricom M-PESA.</p>
                <p>Incase you did not get the request kindly use <strong>option two</strong> below.</p>

                <hr>
                <div class="mt-4 mb-2">
                    <h4 class="font-12">Payment option two</h4>
                    <hr>
                    <p>Go to Safaricom M-PESA Menu, Select Lipa Na Mpesa</p>
                    <p>Select PayBill</p>
