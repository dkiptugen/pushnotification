...
$("#airtimeForm").on('submit', function (e) {
    ...
    if (airtime_confirmation == false) {
        ...
        <strong>Kindly confirm the purchase first</strong>
      </div>`
        );
    ...
    // assign the values
    $("#confirm_amount_to_buy").text(amount);
    $("#confirm_recipient_phone_number").text(recipient_phone_number);
    $("#confirm_mpesa_phone_number").text(mpesa_phone_number);
    $("#confirm_network").text(network);
